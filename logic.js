...
// Add this to your existing script or at the end of your page
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (formToggleBtn && formContainer) {
        formToggleBtn.addEventListener('click', function() {
            const isExpanded = formContainer.style.display === 'block';
            
            if (isExpanded) {
                // Collapse
                formContainer.style.display = 'none';
                formToggleBtn.innerHTML = '<i class="fas fa-chevron-down"></i><span>Show Request Form</span>';
                formToggleBtn.classList.remove('expanded');
            } else {
                // Expand
                formContainer.style.display = 'block';
                formToggleBtn.innerHTML = '<i class="fas fa-chevron-up"></i><span>Hide Request Form</span>';
                formToggleBtn.classList.add('expanded');
